...
<body>
    ...
    <aside class="sidebar">
        <ul>
            ...
            <li><a href="gg5.php">🗓️ Add Timetable</a></li>
            <li><a href="next11.php">🔖 Assign Courses</a></li>
            <li><a href="next22.php">📊 Timetable Summary</a></li>
            <li><a href="next33.php">👥 Staff Availability</a></li>
            <li><a href="next44.php">✅ Final Timetable</a></li>
        </ul>
    </aside>
